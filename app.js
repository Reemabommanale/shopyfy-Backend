...
mongoose.connect('mongodb://127.0.0.1:27017/shopyfyecom')
.then (()=>{
...
app.post('/register',async(req,res)=>{
    try{
        ...
        if(isUserAlreadyExists){
            ...
            const hashesPassword = await bcrypt.hashSync(password,salt);

            //jwt token
            const token = jwt.sign({email},'supersecret',{expiresIn:'365'});
